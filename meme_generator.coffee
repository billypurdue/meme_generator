...
module.exports = (robot) ->
  unless robot.brain.data.memes?
    robot.brain.data.memes = [
      ...
      {
        regex: /(memegen)?(Why the fuck) (.*)/i,
        generatorID: 1440450,
        imageID: 5959710
      },
      {
        regex: /(memegen)?(Why the friend) (.*)/i,
        generatorID: 1440450,
        imageID: 5959710
      },	  
      {
    ...
    .get() (err, res, body) ->
      ...
      msg.http(instanceURL).get() (err, res, body) ->
        ...
        if preferredDimensions?
          callback "https://memegenerator.net/img/instances/#{preferredDimensions}/#{instanceID}/meme.jpg"
        else
          callback "https://memegenerator.net/img/instances/500x/#{instanceID}/meme.jpg"
